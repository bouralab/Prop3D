...
atom_feature_names_flat = [col_name for _, col_names in atom_feature_names.items() for col_name in col_names]
...
residue_feature_names_flat = [col_name for _, col_names in residue_feature_names.items() for col_name in col_names]
