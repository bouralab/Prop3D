...
def build_ibis_dataset(dataset_name, force=False):
    ...
    # jid2 = calculate_ibis_dataset.submit_ibis(dataset_name, ibisdown_path, job_name="build_molmimic_ibis")
    # print "=>Job ID:", jid2

    #3) Add domain information
    print "3. Submitting jobs to add domain information..."
    jid3 = split_domains.load_cdd(dataset_name, ibis_by_cdd, job_name="build_molmimic_sdi") #, dependency="afterany:"+jid2)
    print "=>Job ID:", jid3
