...
from Prop3D.util.pdb import PDB_TOOLS
...
def dock(int_id, pdb1, chain1, sites1, pdb2, chain2, sites2, structures0=1000,
  ...
  docker=True, cores=2, job=None):
    ...
    #complex_file = os.path.join(run_dir, "structures", "water", "analysis", "Prop3Dfit_1.pdb")
    ...
    _orig_file = os.path.join(run_dir, "begin", "Prop3D_1.pdb")
