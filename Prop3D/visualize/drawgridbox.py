...
#from Prop3D.torch_model.torch_loader import IBISDataset
...
def drawgridbox(selection="(all)", volume=256.0, voxel_size=1.0, lw=2.0, r=1.0, g=1.0, b=1.0, alpha=0.4, show_binding_sites=False, oversample=False, undersample=False, show_bonded=False):
    ...
    if show_binding_sites:
        ...
        ibis_dataset = IBISDataset(os.path.join(molpath, "Prop3D", "ibis_luca.tab"), transform=False, input_shape=(256,256,256), balance_classes=bool(undersample))
