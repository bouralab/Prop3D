...
class data_stores(object):
    ...
    """
    def __init__(self, prefix: Union[str, Job, None] = None) -> None:
        self.use_s3 = False
        self.use_file = False
        if prefix is None:
            prefix = ""
    ...
    @property
    def uniref(self) -> IOStore:
        return IOStore.get(f"{self.prefix}Prop3D-uniref")

    def custom_input(self, name: str, create: bool = True) -> IOStore:
